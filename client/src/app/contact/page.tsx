      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <motion.div variants={fadeInUp} className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:michaelrusso819@gmail.com" className="text-blue-600 hover:text-blue-500 transition-colors">
                      michaelrusso819@gmail.com
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4 mt-2">
                      <a href="https://linkedin.com/in/mikerusso3" target="_blank" rel="noopener noreferrer" 
                         className="text-gray-600 hover:text-blue-600 transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                          <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                        </svg>
                      </a>
                      <a href="https://github.com/michael-russo-eng" target="_blank" rel="noopener noreferrer"
                         className="text-gray-600 hover:text-blue-600 transition-colors">
                        <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            >
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Quick Response</h2>
              <p className="text-gray-600">
                I typically respond to all messages within 24 hours. For urgent matters, 
                please feel free to reach out through LinkedIn or email directly.
              </p>
            </motion.div>
          </motion.div>
        </div>
